...
class testCase(TestCase):
    def setUp(self):
        ...
        candidate1 = CandidateProfile.objects.create(user_id = 0, full_name = "", phone = "" ,education = "bachelors", major = "computer science", experience = 2, location = "Wollongong", preferred_work_mode = "remote");
        candidate2 = CandidateProfile.objects.create(user_id = 0, full_name = "", phone = "" ,education = "bachelors", major = "computer science", experience = 3, location = "Wollongong", preferred_work_mode = "remote");
        employer1 = EmployerProfile.objects.create(user_id = 0, company_name ="", location = "Wollongong", description = "")
