...
class testCase(TestCase):
    def setUp(self):
        ...
        user2 = User.objects.create(role = "cand", is_member = False)
        user3 = User.objects.create(role = "empl", is_member = False)
        user4 = User.objects.create(role = "empl", is_member = False)
