...
class testCase(TestCase):
    def setUp(self):
        ...
        candidate2 = CandidateProfile.objects.create(user_id = user1.user_id, full_name = "", phone = "" ,education = "bachelors", major = "computer science", experience = 3, location = "Wollongong", preferred_work_mode = "remote");
        employer1 = EmployerProfile.objects.create(user_id = user1.user_id, company_name ="", location = "Wollongong", description = "")
