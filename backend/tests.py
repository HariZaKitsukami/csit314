...
class testCase(TestCase):
    def setUp(self):
        ...
        candidate2 = CandidateProfile.objects.create(user_id = user1, full_name = "", phone = "" ,education = "hsc", major = "computer science", experience = 3, location = "Wollongong", preferred_work_mode = "remote");
